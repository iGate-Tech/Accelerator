...
export const basePromptStructure = (instructions, variables, outputKeys, problemStatement = '') => `
${problemStatement ? `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
export const standardPromptTemplateWithProblem = (detailedPrompt, variables, problemStatement) => {
  const outputKeys = extractKeysFromPrompt(detailedPrompt);
  return basePromptStructure(detailedPrompt, variables, outputKeys, problemStatement);
};
