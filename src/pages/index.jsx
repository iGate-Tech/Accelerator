...
const Settings = () => {
  ...
  return (
    <div class="mx-auto max-w-6xl space-y-8 overflow-visible px-4 py-6 sm:px-6 sm:py-8">
      ...
      <Show when={message()}>
        <div
          class={`alert ${message().includes('error') ? 'alert-error' : 'alert-success'}`}
        >
          <i
            data-lucide={
              message().includes('error') ? 'alert-circle' : 'check-circle'
            }
            class="h-5 w-5"
          />
          <span>{message()}</span>
      ...
      {/* Settings Content */}
      <div class="bg-base-100 rounded-box border-base-200 border p-4 shadow-sm sm:p-8">
        {/* Preferences */}
        <div class="card bg-base-200 mb-8 rounded-lg p-4 sm:p-6">
          <h2 class="mb-6 flex items-center text-xl font-bold sm:text-2xl">
            <i data-lucide="settings" class="me-2 h-5 w-5 sm:h-6 sm:w-6" />
            {t().preferences}
          </h2>
          ...
          <div class="space-y-6">
            ...
            <div>
              <h3 class="mb-4 text-lg font-semibold">{t().notifications}</h3>
              <div class="space-y-3">
            ...
            {/* Appearance */}
            <div>
              <h3 class="mb-4 text-lg font-semibold">{t().appearance}</h3>
            ...
            {/* Privacy */}
            <div>
              <h3 class="mb-4 text-lg font-semibold">{t().privacy}</h3>
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label class="label">
                ...
                <div>
                  <label class="bg-base-100 flex h-full items-center justify-between rounded-lg p-4">
                    <div>
        ...
        <div class="card bg-base-200 mb-8 rounded-lg p-4 sm:p-6">
          <h2 class="mb-6 flex items-center text-xl font-bold sm:text-2xl">
            <i data-lucide="shield" class="me-2 h-5 w-5 sm:h-6 sm:w-6" />
            {t().accountSecurity}
          </h2>
          ...
          <div class="space-y-6">
            ...
            <div class="card bg-error/5 border-error/20 border">
              <div class="card-body">
                ...
                <p class="text-base-content/70 mb-4">{t().dangerZoneDesc}</p>
                <button
                  class="btn btn-error btn-outline"
                  onClick={deleteAccount}
                >
                  <i data-lucide="trash" class="me-2 h-4 w-4" />
                  {t().deleteAccount}
                </button>
              </div>
            </div>
        ...
        {/* Data & Privacy */}
        <div class="card bg-base-200 rounded-lg p-4 sm:p-6">
          <h2 class="mb-6 flex items-center text-xl font-bold sm:text-2xl">
            <i data-lucide="database" class="me-2 h-5 w-5 sm:h-6 sm:w-6" />
            {t().dataPrivacy}
          </h2>
            ...
            <div class="card bg-base-100">
              <div class="card-body">
                ...
                <div class="space-y-3">
                  ...
                  <label class="btn btn-outline w-full cursor-pointer justify-start gap-2">
            ...
            <div class="card bg-base-100">
              <div class="card-body">
                ...
                <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
                  ...
                  <div class="stat bg-base-200 col-span-2 rounded-lg p-4 sm:col-span-1">
                    <div class="stat-title">{t().storage}</div>
                    <div class="stat-value text-lg">
                      {Math.max((projects() || []).length * 10 + 5, 5)} MB
                    </div>
                  ...
                  <div class="mt-6">
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="text-base-content/60 mt-4 text-xs">
                        <p>
                          <strong>GDPR Compliance:</strong> You can withdraw
                          consent at any time. Last updated:{' '}
                          {consents().updatedAt
                            ? new Date(
                                consents().updatedAt
                              ).toLocaleDateString()
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            if (confirmed) {
                              try {
                                const withdrawn =
                                  await consentManager.withdrawConsents();
                                setConsents(withdrawn);
                                toastManager.success('All consents withdrawn');
                              } catch (error) {
                                toastManager.error(
                                  'Failed to withdraw consents'
                                );
                              }
                            }
                          }}
