            ...
            <div class="flex flex-col h-full min-h-0 transition-all duration-300">
                <div class="flex-shrink-0 relative p-5 flex items-center justify-between rtl:justify-between gap-2">
                    <A href="/"
                        ...
                        <img src={
                                isCollapsed() ? "/src/assets/favicon.svg" : "/src/assets/iGate-tech-logo.svg"
                            }
                            alt="Logo"
                            classList={
                                {
                        ...
                        <Show when={
                            ...
                            <li>
                                <details open={
                                    ...
                                    <div class="dropdown menu w-full min-w-56 rounded-box bg-base-100 shadow-lg border border-base-200 mt-1" popover id="popover-all-projects" style="position-anchor:--anchor-all-projects">
                                        <li>
                                            <A href="/"
                                                onClick={
                                                    () => window.dispatchEvent(new CustomEvent('resetAgent'))
