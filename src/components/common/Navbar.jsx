    ...
    >
      <div class="navbar-start gap-2">
        <Show when={isAuthenticated()}>
          <label
            for="my-drawer-4"
            class="btn btn-square btn-ghost lg:hidden p-1.5"
        ...
        <div class="flex flex-col leading-tight hidden sm:flex">
          <div class="flex items-center gap-2">
            <span class="font-medium text-xl text-base-content/80 tracking-tight">iGate Accelerator</span>
          </div>
          <div class="flex items-center gap-2 mt-0.5">
            <span class="text-xs text-base-content/60">AI-Powered Startup Builder</span>
