...
router.post("/auth/signup", async (req, res) => {
  ...
  try {
    ...
    if (!terms) {
      if (req.isHtmx) {
        res.set('HX-Trigger', '{"show-toast": {"message": "You must accept the Terms of Service and Privacy Policy.", "type": "error"}}');
        return res.send('');
      }
      req.session.flash.error.push("You must accept the Terms of Service and Privacy Policy.");
    ...
    if (!data.session) {
      ...
      if (req.isHtmx) {
        res.set('HX-Trigger', '{"show-toast": {"message": "Account created! Please check your email to confirm your account.", "type": "info"}}');
...
router.post("/auth/logout", async (req, res) => {
  try {
    ...
    if (req.isHtmx) {
      res.set('HX-Trigger', '{"show-toast": {"message": "Logged out successfully", "type": "success"}}');
      res.set('HX-Redirect', '/');
      return res.send('');
    }
