    ...
    return templateStr.replace(/\{\{(\s*)([\w.\-]+)(\s*)\}\}/g, (match, ws1, key, ws2) => {
      ...
      if (value !== undefined) {
        try {
          ...
          console.log(`Injecting {{${key}}}: {{${key}: ${replacement}}}`);
          return `{{${key}: ${replacement}}}`;
        } catch {
          console.log(`Failed to stringify value for ${key}:`, value);
          return match;
        }
      }
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = processLLMTemplate;
  module.exports.extractTemplateData = extractTemplateData;
  module.exports.injectTemplateData = injectTemplateData;
  module.exports.resetTemplatePlaceholders = resetTemplatePlaceholders;
  module.exports.mergeTemplateData = mergeTemplateData;
} else if (typeof define === "function" && define.amd) {
  define([], function () {
    return processLLMTemplate;
  });
