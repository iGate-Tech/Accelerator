...
const ConsentBanner = () => {
  ...
  return (
    <div
      class={`fixed bottom-0 left-0 right-0 bg-base-100 border-t border-base-300 p-4 z-50 shadow-lg transition-transform duration-300 ${
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
          <div class="flex-1">
            ...
            <p class="text-sm text-base-content/70 mb-2">
              We use cookies and local storage to enhance your experience and provide our services.
              By continuing to use our site, you agree to our use of cookies in accordance with our
              <a href="/privacy-policy" class="link link-primary" target="_blank"> Privacy Policy</a>.
            </p>
            <div class="text-xs text-base-content/50">
              <strong>GDPR Compliance:</strong> We only process your data with your consent and provide
