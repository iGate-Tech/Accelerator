...
const TasksContent = () => {
    ...
    const handleStart = async () => {
        ...
        try {
            // Create new project
            const projectData = {
                name: prompt().trim().substring(0, 50) + (prompt().length > 50 ? '...' : ''),
    ...
    return (
        <div class="max-w-md sm:max-w-lg md:max-w-xl lg:max-w-3xl mx-auto h-screen bg-base-100 flex items-center justify-center">
            <AgentInterface
