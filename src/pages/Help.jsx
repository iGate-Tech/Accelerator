  ...
  return (
    <div class="mx-auto max-w-6xl space-y-8 overflow-visible px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div class="tabs tabs-boxed bg-base-100 overflow-x-auto p-1">
        ...
        >
          <i data-lucide="play" class="me-1.5 h-4 w-4" />
        ...
        >
          <i data-lucide="book-open" class="me-1.5 h-4 w-4" />
        ...
        >
          <i data-lucide="zap" class="me-1.5 h-4 w-4" />
        ...
        >
          <i data-lucide="help-circle" class="me-1.5 h-4 w-4" />
          <span>{t().faq}</span>
        </button>
        <button
        ...
        >
          <i data-lucide="video" class="mr-1.5 h-4 w-4" />
        ...
        >
          <i data-lucide="message-circle" class="me-1.5 h-4 w-4" />
          ...
          <div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:gap-4">
              <button class="btn btn-outline btn-sm" onClick={resetTutorial}>
                <i data-lucide="rotate-ccw" class="me-2 h-4 w-4" />
                {t().resetProgress}
              </button>
              <div class="alert alert-info flex-1 text-sm">
                <i data-lucide="info" class="h-5 w-5 flex-shrink-0" />
                <div>
        ...
        <Show when={activeSection() === 'features'}>
          <div>
            ...
            <div class="alert alert-success mt-6 text-sm sm:mt-8">
              <i data-lucide="check-circle" class="h-5 w-5 flex-shrink-0" />
              <div>
        ...
        <Show when={activeSection() === 'videos'}>
          <div>
                    ...
                    <div class="card-body p-4">
                      ...
                      <div class="mt-2 flex items-center justify-between sm:mt-3">
                        ...
                        <button class="btn btn-primary btn-sm">
                          <i data-lucide="play" class="me-1 h-4 w-4" />
                          {t().watch}
                        </button>
                      </div>
                    </div>
            ...
            <div class="alert alert-info mt-6 text-sm sm:mt-8">
              <i data-lucide="video" class="h-5 w-5 flex-shrink-0" />
              <div>
        ...
        <Show when={activeSection() === 'faq'}>
          <div>
            ...
            <div class="alert alert-warning mt-6 text-sm sm:mt-8">
              <i data-lucide="message-circle" class="h-5 w-5 flex-shrink-0" />
              <div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
                  ...
                  >
                    <div class="space-y-3 sm:space-y-4">
                      ...
                      <button type="submit" class="btn btn-primary w-full">
                        <i data-lucide="send" class="me-2 h-4 w-4" />
                        {t().send}
                      </button>
                    </div>
                  </form>
              ...
              <div class="space-y-4 sm:space-y-6">
                ...
                <div class="card bg-base-200 shadow-sm">
                  <div class="card-body p-4 sm:p-6">
                    ...
                    <div class="space-y-2">
                      ...
                      <button class="btn btn-outline btn-sm w-full justify-start gap-2">
                        <i data-lucide="github" class="h-4 w-4" />
                        <span class="truncate">{t().githubIssues}</span>
                      </button>
                      <button class="btn btn-outline btn-sm w-full justify-start gap-2">
                        <i data-lucide="twitter" class="h-4 w-4" />
                ...
                <div class="alert alert-info text-sm">
                  <i data-lucide="clock" class="h-5 w-5 flex-shrink-0" />
                  <div>
        ...
        <div class="stats stats-vertical sm:stats-horizontal bg-base-100 rounded-box max-w-full shadow">
          <div class="stat py-3">
            <div class="stat-figure text-primary">
              <i data-lucide="help-circle" class="h-6 w-6 sm:h-8 sm:w-8" />
            </div>
          ...
          <div class="stat py-3">
            <div class="stat-figure text-secondary">
              <i data-lucide="users" class="h-6 w-6 sm:h-8 sm:w-8" />
            </div>
          ...
          <div class="stat py-3">
            <div class="stat-figure text-accent">
              <i data-lucide="clock" class="h-6 w-6 sm:h-8 sm:w-8" />
            </div>
        ...
        <div class="mt-6 sm:mt-8">
          ...
          <div class="flex flex-wrap justify-center gap-2 sm:gap-4">
            <button
              ...
              onClick={() => setActiveSection('contact')}
            >
              <i data-lucide="message-circle" class="h-4 w-4" />
              <span class="hidden sm:inline">{t().contact}</span>
            </button>
            <button class="btn btn-outline btn-sm gap-2">
              <i data-lucide="external-link" class="h-4 w-4" />
