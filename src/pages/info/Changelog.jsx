...
import { Info, CheckCircle, AlertCircle, AlertTriangle, XCircle, Plus, ArrowUp, Bug, Circle } from 'lucide-solid';
                  ...
                  {change => (
                    <div class="flex items-start gap-3">
                      {(() => {
                        ...
                        return <IconComponent class={`mt-0.5 h-4 w-4 ${getChangeColor(change.type)}`} />;
                      })()}
