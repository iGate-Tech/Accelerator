...
function loadTranslations(lang) {
  ...
  try {
    ...
    console.log(
      `Loaded ${lang} translations with ${totalKeys} keys into flat structure`,
    );
  } catch (error) {
  ...
  return { translation: translations };
    ...
    console.log(
      `Loaded ${lang} translations with ${totalKeys} keys from ${files.length - 1} separate files`,
    );
    console.log(`${lang} namespaces:`, Object.keys(translations).slice(0, 10));
  } catch (error) {
    console.error(`Error reading ${lang} locales directory:`, error.message);
  }
...
// Initialize i18n with single namespace
