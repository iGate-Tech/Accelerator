    ...
    send: 'Send',
     ...
     featuresActiveDesc: 'Every feature mentioned above is fully functional and ready to use. Explore the app to discover them all!',
      ...
      githubIssues: 'GitHub Issues',
       ...
       exportProjectsDesc: "Yes, you can export individual projects or all projects at once from the sidebar menu. Projects are exported as JSON files for backup or sharing. You can also import projects and access data export features.",
       pauseResume: "How do I pause and resume projects?",
       pauseResumeDesc: "While working on a project, you can use the pause and resume buttons in the agent interface. This allows you to take breaks and continue where you left off. Paused projects retain all progress and can be resumed immediately.",
    ...
    send: 'إرسال',
     ...
     featuresActiveDesc: 'كل ميزة مذكورة أعلاه تعمل بالكامل وجاهزة للاستخدام. استكشف التطبيق لاكتشافها جميعاً!',
      ...
      exportProjectsDesc: "نعم، يمكنك تصدير مشاريع فردية أو جميع المشاريع مرة واحدة من قائمة الشريط الجانبي. يتم تصدير المشاريع كملفات JSON للنسخ الاحتياطي أو المشاركة. يمكنك أيضاً استيراد المشاريع والوصول إلى ميزات تصدير البيانات.",
       ...
       aiResponseFailsDesc: "If an AI response fails, the system will automatically retry with exponential backoff (60s, 120s, 240s). If all retries fail, it will move to the next step or allow you to continue manually. Check your internet connection and the server status indicator.",
      ...
      deleteProjectsDesc: "يمكن حذف المشاريع بشكل فردي من قائمة الشريط الجانبي أو بشكل جماعي باستخدام خيار 'حذف جميع المشاريع'. كن حذراً حيث لا يمكن التراجع عن هذا الإجراء. فكر في تصدير المشاريع قبل الحذف للنسخ الاحتياطي.",
       ...
       darkModeDesc: "Click the sun/moon icon in the top right navigation bar to switch between light and dark themes. Your preference is automatically saved and persists across sessions.",
