      ...
      <div class="w-full max-w-md mx-auto">
        ...
        <div class="flex justify-center mb-8">
          <svg width="48" height="52" viewBox="131.813 251.178 668.768 222.94" xmlns="http://www.w3.org/2000/svg" xmlns:bx="https://boxy-svg.com" class="h-12 w-auto">
            <defs>
              <linearGradient id="green-yellow-su" x1="0%" y1="0%" x2="0%" y2="100%" gradientTransform="matrix(0.942709, 0.333618, -0.150908, 0.426427, 0, 0)">
                <stop offset="0" stop-color="#6cd14d"/>
                <stop offset="1" stop-color="#ffc600"/>
              </linearGradient>
              <linearGradient id="purple-blue-su" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0" stop-color="#00a7e0"/>
                <stop offset="1" stop-color="#9e28b5"/>
              </linearGradient>
              <linearGradient id="gradient-1-su" bx:pinned="true"/>
              <linearGradient id="gradient-2-su" bx:pinned="true">
                <stop offset="0" style="stop-color: rgb(0, 167, 224);"/>
                <stop offset="1" style="stop-color: rgb(158, 40, 181);"/>
              </linearGradient>
              <linearGradient id="gradient-0-su" bx:pinned="true">
              ...
              <linearGradient id="gradient-5-su" bx:pinned="true">
                <stop offset="0" style="stop-color: rgb(108, 208, 76);"/>
                <stop offset="1" style="stop-color: rgb(255, 198, 0);"/>
              </linearGradient>
              <linearGradient id="gradient-3-su" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0" stop-color="#00a7e0"/>
                <stop offset="1" stop-color="#9e28b5"/>
              </linearGradient>
              <linearGradient id="gradient-2-1-su" href="#gradient-2-su" gradientUnits="userSpaceOnUse" x1="369.824" y1="258.28" x2="369.824" y2="419.898" gradientTransform="matrix(1.298064, 0.947677, -0.363133, 0.497397, -202.742569, -197.590729)"/>
              <linearGradient id="gradient-4-su" x1="0%" y1="0%" x2="0%" y2="100%" gradientTransform="matrix(0.942709, 0.333618, -0.150908, 0.426427, 0, 0)">
                <stop offset="0" stop-color="#6cd14d"/>
                <stop offset="1" stop-color="#ffc600"/>
              </linearGradient>
              <linearGradient id="gradient-6-su" x1="0%" y1="0%" x2="0%" y2="100%" gradientTransform="matrix(0.942709, 0.333618, -0.150908, 0.426427, 0, 0)">
                <stop offset="0" stop-color="#6cd14d"/>
                <stop offset="1" stop-color="#ffc600"/>
              </linearGradient>
            </defs>
              ...
              <g>
                <g id="Layer_1" transform="matrix(1, 0, 0, 1, 171.58522, 14.641378)">
                  <g transform="matrix(1, 0, 0, 1, 73.123965, -108.644679)">
                    ...
                    <g transform="matrix(1, 0, 0, 1, -96.212367, 106.556072)">
                      <path class="cls-2" d="" style="fill: url(&quot;#purple-blue-su&quot;); stroke-width: 0px;"/>
                      <path class="cls-4" d="" style="fill: url(&quot;#green-yellow-su&quot;); stroke-width: 0px;"/>
                    </g>
                  </g>
