...
import { ThumbsUp, ThumbsDown, Clock, Cpu, Eye, X, EyeOff, CheckCircle, Loader, Circle, PauseCircle } from 'lucide-solid';
      ...
      <div class="card-body p-3 md:p-4">
        ...
        <div class="mb-2 flex items-start justify-between gap-2 md:mb-3">
          ...
          {showStatus && (
            ...
            >
              {(() => {
                const IconComponent = getStatusIcon(project.ui_status);
                return <IconComponent class="h-2.5 w-2.5 md:h-3 md:w-3" />;
              })()}
          ...
          <div class="bg-primary/5 absolute inset-0 flex items-center justify-center rounded-lg opacity-0 transition-opacity duration-200 hover:opacity-100">
            <div class="flex flex-col gap-2">
              ...
              {showVisibilityToggle && (
                ...
                >
                  {isPublic() ? <Eye class="me-1 inline h-3 w-3" /> : <EyeOff class="me-1 inline h-3 w-3" />}
