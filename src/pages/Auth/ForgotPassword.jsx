    ...
    <div class="card max-w-md mx-auto shadow-2xl bg-base-100 border border-base-300 backdrop-blur-sm">
        <div class="card-body">
           <div class="text-center mb-8">
             <svg width="48" height="52" viewBox="131.813 251.178 668.768 222.94" xmlns="http://www.w3.org/2000/svg" xmlns:bx="https://boxy-svg.com" class="mx-auto mb-4" style="height: 52px; width: auto;">
               <defs>
